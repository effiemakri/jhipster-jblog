package eu.telint.jblog.repository;

import eu.telint.jblog.JblogApp;
import eu.telint.jblog.config.Constants;
import eu.telint.jblog.config.audit.AuditEventConverter;
import eu.telint.jblog.domain.PersistentAuditEvent;
...
import static eu.telint.jblog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
